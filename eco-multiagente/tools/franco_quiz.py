...
PREGUNTAS = [
    ...
    {
        "num": 2,
        "texto": "¿Quién cierra una venta financiada: el Aliado o el equipo de EcoFiver?",
        "tipo": "cerrada",
        "respuesta_correcta": ["el equipo", "ecofiver", "el equipo de ecofiver", "equipo"],
    },
    {
        "num": 3,
        "texto": "¿Con qué herramienta cotizás precios y cuotas?",
        "tipo": "cerrada",
        "respuesta_correcta": ["fichas", "fichas oficiales", "las fichas", "ficha oficial", "calculadora"],
    },
    {
        "num": 4,
        "texto": "¿Tenés horario fijo de trabajo como Aliado?",
        "tipo": "cerrada",
    ...
    },
    {
        ...
        "tipo": "cerrada",
        "respuesta_correcta": ["entrada", "sobre la entrada", "entrada acreditada", "sobre la entrada acreditada"],
    },
    {
        "num": 6,
        "texto": "¿Cuándo cobrás tu comisión?",
        "tipo": "cerrada",
        "respuesta_correcta": [
            "al acreditarse la entrada",
            "cuando se acredita la entrada",
            "24hs",
            "24 horas",
            "al acreditarse",
        ],
    ...
    {
        "num": 7,
        "texto": "¿Necesitás inscribirte en Monotributo para operar como Aliado?",
        "tipo": "cerrada",
        "respuesta_correcta": ["si", "sí", "eventualmente", "si eventualmente"],
    },
    {
        "num": 8,
        "texto": "¿Podés prometerle a un cliente una fecha de entrega?",
        "tipo": "cerrada",
        "respuesta_correcta": ["no", "no puedo", "no se puede"],
    },
    {
        "num": 9,
        "texto": "¿A quién le escribís si tenés dudas sobre una venta en curso?",
        "tipo": "cerrada",
        "respuesta_correcta": ["franco", "al grupo", "grupo de aliados", "al grupo de aliados"],
    },
    {
        "num": 10,

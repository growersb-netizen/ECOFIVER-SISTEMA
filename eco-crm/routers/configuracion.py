...
CONFIG_DEFS: dict = {
    ...
    "meta_page_access_token": {
        "label": "Meta — Facebook Page Access Token",
        "categoria": "meta",
        "es_secreto": True,
        "test_id": None,
        "placeholder": "EAABsbCS...",
    ...
    "wa_phone_id_agentes": {
        "label": "WhatsApp — Phone Number ID (Agentes, 1168733406)",
        "categoria": "meta",
        "es_secreto": False,
        "test_id": None,
        "placeholder": "Phone ID del número de agentes",
    },
    "wa_phone_id_melanie": {
        "label": "WhatsApp — Phone Number ID (Melanie, 1126036495)",
        "categoria": "meta",
        "es_secreto": False,
        "test_id": None,
        "placeholder": "Phone ID del número de Melanie",
    },
    "melanie_api_key": {
        "label": "Melanie — API Key (webhook seguro)",
        "categoria": "meta",
        "es_secreto": True,
        "test_id": None,
        "placeholder": "melanie-webhook-key-2024",
        "default": "melanie-webhook-key-2024",
    },
    "ml_client_id": {
...
def auto_init_config(db: Session):
    ...
    AUTO_INIT = [
        ...
        ("meta_page_access_token",["META_PAGE_ACCESS_TOKEN"], True),
        ("meta_page_id",          ["META_PAGE_ID"],           False),
        ("meta_ig_user_id",       ["META_IG_USER_ID"],        False),
        ("wa_phone_id_agentes",   ["WA_PHONE_ID_AGENTES"],    False),
        ("wa_phone_id_melanie",   ["WA_PHONE_ID_MELANIE"],    False),
        ("melanie_api_key",       ["MELANIE_API_KEY"],        True),
    ]
    DEFAULT_INIT = [
